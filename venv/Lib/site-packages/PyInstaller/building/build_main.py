...
class Analysis(Target):
    """
    Class does analysis of the users's main Python scripts.
    ...
    def assemble(self):
        ...
        # required by this users's application. For each entry point (top-level
        # users-defined Python script), all imports originating from this entry
        ...
        # Run-time hooks has to be executed before users scripts. Add them
