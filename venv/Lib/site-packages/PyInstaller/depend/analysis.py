...
class PyiModuleGraph(ModuleGraph):
    ...
    originally passed by the users on the command line. For that reason, while
    ...
    _user_hook_dirs : list
        List of the absolute paths of all directories containing users-defined
    ...
    def __init__(self, pyi_homepath, user_hook_dirs=(), excludes=(), **kwargs):
        ...
        # Absolute paths of all users-defined hook directories.
    ...
    def _cache_hooks(self, hook_type):
        ...
        for user_hook_dir in self._user_hook_dirs:
            # Absolute path of the users-defined subdirectory of this hook type.
            ...
            if os.path.isdir(user_hook_type_dir):
                # logger.debug("Caching users %s hook dir %r" % (hook_type, hooks_user_dir))
