...
class BaseServer(object):
    ...
    def init_socket(self):
        """
        If the users initialized the server with an address rather than
        socket, then this function must create a socket, bind it, and
        put it into listening mode.

        It is not supposed to be called by the users, it is called by :meth:`start` before starting
        the accept loop.
        """
