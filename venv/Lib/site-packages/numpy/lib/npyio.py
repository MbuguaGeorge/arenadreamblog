...
def loadtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    try:
        ...
        # By preference, use the converters specified by the users
        for i, conv in (user_converters or {}).items():
            ...
            if byte_converters:
                ...
                # so encode the string again before passing to the users converter
...
def genfromtxt(fname, dtype=float, comments='#', delimiter=None,
    ...
    * Individual values are not stripped of spaces by default.
    ...
    with fid_ctx:
        ...
        # Update the converters to use the users-defined ones
        uc_update = []
...
#        else:
    ...
    if dtype is None:
        ...
        # Case #2. We have a basic dtype
            ...
            # We used some users-defined converters
            if user_converters:
                ishomogeneous = True
                descr = []
