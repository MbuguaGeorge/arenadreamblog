...
def generate_pool_name(**kwargs):
    ...
    """
    parts = []
    for key in ("host", "port", "users", "database", "client_id"):
        try:
...
class PooledConnection(Connection):
    ...
    def close_session(self):
        ...
        state will be cleared by re-authenticating the users once the connection
...
class Session(object):
    ...
    def __init__(self, settings):
        ...
        if schema:
            try:
                ...
                # Access denied for users will raise err.errno = 1044
    ...
    def _init_attributes(self):
        """Setup default and users defined connection-attributes."""
        if os.name == "nt":
